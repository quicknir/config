...
before packages are loaded."
  ...
  (evil-define-key 'insert c++-mode-map (kbd "C-f") 'ycmd/manual-semantic-company-completer)
  (evil-define-key 'insert python-mode-map (kbd "C-f") 'ycmd/manual-semantic-company-completer)
