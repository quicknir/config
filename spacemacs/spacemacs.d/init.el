...
;; you should place your code here."
 ...
 ;;    )
  ...
  (spacemacs/set-leader-keys "sb" (followize helm-source-do-ag 'helm-do-ag-buffers))
  (spacemacs/set-leader-keys "sB" (followize helm-source-do-ag 'spacemacs/helm-buffers-do-ag-region-or-symbol))
  (spacemacs/set-leader-keys "ss" (followize helm-source-do-ag 'helm-do-ag-this-file))
  (spacemacs/set-leader-keys "sS" (followize helm-source-do-ag 'spacemacs/helm-file-smart-do-search-region-or-symbol))
